...
The twelve figures are numbered across the whole document rather than per sheet ([A.13](sec_ai_a#a13)), and each one lives in the sheet it illustrates — so this is the only place they can be seen as a set. The glossary is [Z1](sec_ai_z1).
...
| Fig. 3 | [D — Embedded controller](sec_ai_d) | The nine-step boot sequence — steps 1–6 the EC's, from step 7 the 65816's |
