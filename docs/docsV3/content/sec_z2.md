...
The twelve figures are numbered across the whole document rather than per sheet ([A.13](sec_a#a13)), and each one lives in the sheet it illustrates — so this is the only place they can be seen as a set. The glossary is [Z1](sec_z1).
