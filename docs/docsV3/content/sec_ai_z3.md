...
| Softcore | A CPU implemented as gateware rather than as a chip. Argon's optional 65816 is one (→ [sheet E](sec_ai_e)). The footprint ships unpopulated, and what a core owes the board is a pin list as much as an instruction set ([E.13](sec_ai_e#e13)). |
