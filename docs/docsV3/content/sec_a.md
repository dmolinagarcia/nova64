...
- A.7 — Scope of this document: an index + outline tying all the pieces together. Detail lives in the sheets: `hoja-1-2-rp2040.md` … `hoja-1-6-conectores.md`, `hoja-pines-ice40.md`, `plan-implementacion-65816.md`, `helium-debug-agent.md` and the diagram `placa-65816.html`.
